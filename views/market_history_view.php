                        ...
                        <div class="card-header ">
                            <div class="row">
                                <div class="col-sm-6 text-left">
                                    <h2 class="card-title">Marketplace history</h2>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="table_id" class="display">
                                ...
                                <?php while ($data = $story->fetch()) { ?>
                                    <tr>
                                        ...
                                        <td><?= $data['seller'] ?></td>
                                        <td><?= $data['added'] ?></td>
                                        <td><a href="<?= $data['item_link'] ?>"><button class="btn btn-primary animation-on-hover" type="button"><i class="tim-icons icon-cloud-download-93"></i> Download</button></a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
